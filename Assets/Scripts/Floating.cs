...
public class Floating : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        centerOffset = WaterPhysics.GetCenter(WaterLinePoints) - transform.position;
    ...
    void FixedUpdate()
    {
        ...
        //compute up vector
        TargetUp = WaterPhysics.GetNormal(WaterLinePoints);
        ...
        if (WaterLine > Center.y){
            ...
            {
                //go up
                //AffectDirection ? TargetUp * -Physics.gravity.y : 
